          ...
          <div className="projects-preview">
            <div className="project-card">
              <div className="project-image">
                <img src="/api/placeholder/350/200" alt="Reforestation Project" />
              </div>
            ...
            <div className="project-card">
              <div className="project-image">
                <img src="/api/placeholder/350/200" alt="Renewable Energy Project" />
              </div>
              <div className="project-content">
            ...
            <div className="project-card">
              <div className="project-image">
                <img src="/api/placeholder/350/200" alt="Community Projects" />
              </div>
              <div className="project-content">
